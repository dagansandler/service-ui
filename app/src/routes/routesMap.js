...
import { fetchTmsFoldersAction } from 'controllers/tms';
import {
  API_KEYS_ROUTE,
...
const routesMap = {
  ...
  [TEST_CASE_LIBRARY_PAGE]: {
    path: '/organizations/:organizationSlug/projects/:projectSlug/testCaseLibrary',
    thunk: (dispatch) => {
      dispatch(fetchTmsFoldersAction());
    },
  },
  [TEST_CASE_DETAILS_PAGE]:
